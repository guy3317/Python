    ...
    while flag == 0:
        ...
        try:
            ...
            if PlayerX == 1 and T[0][0] != "O" and T[0][0] != "X":
                ...
                print("\nInvalid Choice!\n")
            if PlayerX == 1 and T[0][0] == "O" and T[0][0] == "X" or PlayerX == 2 and T[0][1] == "O" and T[0][1] == "X" or PlayerX == 3 and T[0][2] == "O" and T[0][2] == "X" or PlayerX == 4 and T[1][0] == "O" and T[1][0] == "X" or PlayerX == 5 and T[1][1] == "O" and T[1][1] == "X" or PlayerX == 6 and T[1][2] == "O" and T[1][2] == "X" or PlayerX == 7 and T[2][0] == "O" and T[2][0] == "X" or PlayerX == 8 and T[2][1] == "O" and T[2][1] == "X" or PlayerX == 9 and T[2][2] == "O" and T[2][2] == "X":
                print("\nInvalid Choice!\n")
        except ValueError:
            print("\nInvalid Choice!\n")
    ...
    while flag == 1 and roundEnded == 1:
        try:
            ...
            if PlayerO == 1 and T[0][0] != "X" and T[0][0] != "O":
                ...
                print("\nInvalid Choice!\n")
            if PlayerO == 1 and T[0][0] == "X" and T[0][0] == "O" or PlayerO == 2 and T[0][1] == "X" and T[0][1] == "O" or PlayerO == 3 and T[0][2] == "X" and T[0][2] == "O" or PlayerO == 4 and T[1][0] == "X" and T[1][0] == "O" or PlayerO == 5 and T[1][1] == "X" and T[1][1] == "O" or PlayerO == 6 and T[1][2] == "X" and T[1][2] == "O" or PlayerO == 7 and T[2][0] == "X" and T[2][0] == "O" or PlayerO == 8 and T[2][1] == "X" and T[2][1] == "O" or PlayerO == 9 and T[2][2] == "X" and T[2][2] == "O":
                print("\nInvalid Choice!\n")
        except ValueError:
            print("\nInvalid Choice!\n")